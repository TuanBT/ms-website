...
fnStateLoaded: null, fnStateSaveCallback: function (a, b) { try { (-1 === a.iStateDuration ? sessionStorage : localStorage).setItem("DataTables_" + a.sInstance + "_" + location.pathname, JSON.stringify(b)) } catch (c) { } }, fnStateSaveParams: null, iStateDuration: 7200, iDeferLoading: null, iDisplayLength: 10, iDisplayStart: 0, iTabIndex: 0, oClasses: {}, oLanguage: {
    oAria: { sSortAscending: ": Thực hiện sắp xếp cột tăng dần", sSortDescending: ": Thực hiện sắp xếp cột giảm dần" }, oPaginate: { sFirst: "Đầu", sLast: "Cuối", sNext: "Kế tiếp", sPrevious: "Trước đó" },
sEmptyTable:"Không có dữ liệu hiển thị",sInfo:"Đang hiện _START_ tới _END_ của _TOTAL_ hàng",sInfoEmpty:"Đang hiện 0 tới 0 của 0 hàng",sInfoFiltered:"(Lọc từ _MAX_ tổng kết quả)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Hiển thị _MENU_ hàng",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Tìm kiếm:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Không tìm thấy"},oSearch:h.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,
