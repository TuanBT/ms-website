...
namespace MS_Website.Controllers
{
    public class CustomerController : Controller
    {
        ...
        public ActionResult AddRecruitment(string gender, string age, string LanguageEnglish, 
            ...
            string Cooking, string Washing, string CleanHouse, string custId, string time)
        {
            if (custId != null)
            {
                using (var db = new MSEntities())
                {
                    ...
                    if (!exp.Equals("null"))
                    {
                        skillRef.Experience = db.SkillInstances.SingleOrDefault(si => si.SkillString.Equals(exp)).SkillId;
                    }
                    if (!hometown.Equals("null"))
                    {
                        skillRef.Hometown = db.SkillInstances.SingleOrDefault(si => si.SkillString.Equals(hometown)).SkillId;
                    }
                    if (!addr.Equals("null"))
                    {
                    ...
                    {
                        skillRef.Married = db.SkillInstances.SingleOrDefault(si => si.SkillString.Equals(married)).SkillId;
                    }
                    if (!stay.Equals("null"))
                    {
                    ...
                    recruitment.CustomerId = (int)Session["AccId"];
